        ...
        <div id="sidebar-menu" class="sidebar-menu">
            <nav class="greedys sidebar-horizantal">
                <ul class="list-inline-item list-unstyled links">
                    ...
                    <li class="<?php echo ($page == 'tickets.php' || $page == 'ticket-view.php')?'active':'';?>"> 
                ...
                <div class="sidebar sidebar-twocol">
                    <div class="sidebar-left slimscroll">
                        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            ...
                            <a class="nav-link <?php echo ($page == 'tickets.php' || $page == 'tickets-view.php')?'active':'';?>" id="v-pills-tickets-tab" title="Tickets" data-bs-toggle="pill" href="#v-pills-tickets" role="tab" aria-controls="v-pills-tickets" aria-selected="false">
                                <span class="material-icons-outlined">
                                    confirmation_number
                                </span>
                            </a>
                    ...
                    <div class="sidebar-right">
                        <div class="tab-content" id="v-pills-tabContent">
                            ...
                            <div class="tab-pane fade <?php echo ($page == 'tickets.php' || $page == 'ticket-view.php')?'show active':'';?>" id="v-pills-tickets" role="tabpanel" aria-labelledby="v-pills-tickets-tab">
                                <p>Tickets</p>
                                <ul>
