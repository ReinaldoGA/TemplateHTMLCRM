/*
Author       : Dreamguys
Template Name: SmartHR - Materializecss Admin Template
Version      : 3.6
*/
...
$(document).ready(function() {
	...
	$(document).on('click', '.leave-edit-btn', function() {
		...
		$(this).closest("div.leave-right").append('<button class="btn waves-effect btn-primary leave-save-btn" type="submit">Save</button>');
...
$(document).ready(function(){
	...
	$('.left-position.dropdown-trigger').dropdown({
		coverTrigger:false,
		constrainWidth: false,
		alignment: "left",
	});	
